...
namespace Bullet3
{
	...
	struct RigidBodyData {
		inline RigidBodyData() : shape(nullptr), state(nullptr), trans(), inertia(0.f), mass(0.f) {
	...
	*/
	...
	inline btRigidBody* createRigidBodyFrom(const RigidBodyData& data) {
		btRigidBody* body = createType<btRigidBody>(data.mass, data.state, data.shape, tobtVec3(data.inertia));
